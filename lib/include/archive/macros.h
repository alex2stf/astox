...
// Define NaN (Not-a-Number) on Windows
        ...
        //only msc have the following headers:
...
//C++11 - 201103L
        ...
        #define SUPPORT_CPP_11
    #endif

    //https://en.cppreference.com/w/c/chrono/localtime
    #if defined(__STDC_LIB_EXT1__) || defined(ASTOX_COMPILER_MSC)
        #define SUPPORT_LOCALTIME_S
