...
namespace astox {
    ...
    namespace SelfConfigure {
        ...
        void saveMakefile(std::string srcDir) {
            ...
            astox::stringAlg::write_string_to_file(makefileData, _makefileName);
        ...
        Value * makeFileCallback(Value * object) {
            ...
            std::string extension = data->getValue("extension")->str();
            std::string fileName = data->getValue("filename")->str();
            std::string filePath = data->getValue("path")->str();
            std::string fileNameNoExt = data->getValue("fileNameNoExt")->str();
        ...
        Value * selfConfigureCallback(Value * object) {
            ...
            std::string extension = data->getValue("extension")->str();
            bool isDirectory = data->getValue("isDirectory")->toBool();
            std::string fileName = data->getValue("filename")->str();
            std::string filePath = data->getValue("path")->str();
            ...
            if (extension == "app") {
                ...
                std::string execPath = data->getValue("path")->str();
